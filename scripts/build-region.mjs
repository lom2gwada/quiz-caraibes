...
const lines = [
  ...
  '',
  '// Paramètres de la projection équirectangulaire partagée (voir 2-3 ci-dessus), exportés pour',
  '// pouvoir convertir un point quelconque lon/lat <-> unités de viewBox à la volée (carte plein',
  '// écran interactive) sans reconstruire toute la projection depuis Natural Earth.',
  '// vue_x = lon * k * scale + ox ; vue_y = -lat * scale + oy',
  `export const REGION_PROJECTION = { k: ${k}, scale: ${scale}, ox: ${ox}, oy: ${oy} }`,
  '',
