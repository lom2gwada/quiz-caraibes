...
// Une vue par mode (quiz_forge_leaderboard_*, cf. migration) : meilleure ligne par joueur et par
// quiz, déjà jointe à quiz_forge_profiles pour pseudo/avatar (vue security-definer, volontaire —
...
const VIEW_BY_MODE: Record<GameMode, string> = {
  classic: 'quiz_forge_leaderboard_classic',
  timeAttack: 'quiz_forge_leaderboard_time_attack',
  noMistake: 'quiz_forge_leaderboard_no_mistake',
}
